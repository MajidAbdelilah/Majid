...
CPP      = g++
CC       = gcc
OBJ      = obj/renderer.o obj/camera.o obj/ufbx.o obj/model_loader.o obj/image.o obj/main.o obj/mathc.o
LINKOBJ  = obj/renderer.o obj/camera.o obj/ufbx.o obj/model_loader.o obj/image.o obj/main.o obj/mathc.o
CLEANOBJ  =  obj/renderer.o obj/camera.o obj/ufbx.o obj/model_loader.o obj/image.o obj/main.o obj/mathc.o "bin/Majid Game Engine"
...
CFLAGS   = $(INCS)  -std=gnu99 -g3 -O1 -pipe -Wall -D__DEBUG__
RM       = rm -rf
...
obj/renderer.o: src/renderer.c src/renderer.h src/mathc.h src/ufbx/sokol_gfx.h src/renderer_structs.h src/image.h src/model_loader.h src/camera.h src/ufbx.h src/ufbx/umath.h
...
obj/model_loader.o: src/model_loader.c src/mathc.h src/ufbx/sokol_gfx.h src/renderer_structs.h src/image.h src/model_loader.h src/ufbx.h src/ufbx/umath.h
...
obj/main.o: src/main.c src/renderer.h src/camera.h
